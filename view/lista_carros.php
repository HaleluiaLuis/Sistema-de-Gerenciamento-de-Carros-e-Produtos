    ...
    <div class="bg-gray-800 rounded-lg shadow-lg w-full max-w-6xl p-4">
        <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-3/4 p-4">
                ...
                <form method="GET" action="lista_carros.php" class="mb-6">
                    <input type="text" name="search" placeholder="Pesquisar carros..." class="w-full p-2 rounded-lg bg-gray-700 text-white placeholder-gray-400">
                </form>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php
                    foreach ($carros as $carro) {
                        $imagemPath = '../uploads/' . htmlspecialchars($carro['imagem_url']);
                        if (!file_exists($imagemPath)) {
                            $imagemPath = '../uploads/default.jpg';
                        }
                        ...
                        echo '</div>';
                        echo '<img alt="' . htmlspecialchars($carro['modelo']) . '" class="w-full h-32 object-cover rounded-lg mb-4" height="150" src="' . $imagemPath . '" width="300"/>';
