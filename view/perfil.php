...
$usuario = $perfilController->visualizarPerfil($_SESSION['user_id']);
?>
...
<head>
    ...
    <title>Car Rentals - Meu Perfil</title>
...
<body class="bg-gray-800 min-h-screen flex items-center justify-center">
    ...
    <?php } ?>
            ...
            <div class="w-full md:w-3/4 p-4">
                <h2 class="text-2xl text-white font-bold mb-6">Meu Perfil</h2>
                <div class="bg-gray-700 rounded-lg p-4">
                    <div class="flex items-center mb-4">
                        <img alt="User profile picture" class="rounded-full mr-4" height="80" src="../uploads/<?php echo htmlspecialchars($usuario->getImagem()); ?>" width="80"/>
                        <div>
                            <div class="text-white text-2xl font-bold"><?php echo htmlspecialchars($usuario->getNome()); ?></div>
                            <div class="text-gray-400"><?php echo htmlspecialchars($usuario->getEmail()); ?></div>
                        </div>
                    </div>
                    <div class="text-white mb-4">
                        <div class="font-bold">Telefone:</div>
                        <div><?php echo htmlspecialchars($usuario->getTelefone()); ?></div>
                    </div>
                    <div class="text-white mb-4">
                        <div class="font-bold">Endereço:</div>
                        <div><?php echo htmlspecialchars($usuario->getEndereco()); ?></div>
                    </div>
                    <div class="text-white mb-4">
                        <div class="font-bold">Data de Nascimento:</div>
                        <div><?php echo htmlspecialchars($usuario->getDataNascimento()); ?></div>
                    </div>
                </div>
            </div>
        </div>
