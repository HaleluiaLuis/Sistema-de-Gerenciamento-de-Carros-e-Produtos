<html lang="en">
 ...
 <body class="bg-gray-800 min-h-screen flex items-center justify-center">
  <div class="bg-gray-800 rounded-lg shadow-lg w-full max-w-6xl p-4">
   <div class="flex">
    <!-- Sidebar -->
    <div class="w-1/4 bg-gray-900 rounded-lg p-4">
     ...
     <ul class="space-y-4">
      ...
      <li class="flex items-center text-white cursor-pointer">
       <i class="fas fa-car mr-3">
       </i>
       Cars
      </li>
      <li class="flex items-center text-gray-400 hover:text-white cursor-pointer">
    ...
    <div class="w-3/4 p-4">
     <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex items-center space-x-4">
       <i class="fas fa-filter text-white">
       </i>
       <i class="fas fa-th-large text-white">
       </i>
     ...
     <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="bg-gray-700 rounded-lg p-4">
       <div class="flex justify-between items-center mb-4">
        ...
        <i class="far fa-heart text-white">
        </i>
       </div>
